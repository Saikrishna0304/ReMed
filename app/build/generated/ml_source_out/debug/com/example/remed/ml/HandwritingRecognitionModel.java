...
public final class HandwritingRecognitionModel {
  @NonNull
  private final Model model;

  private HandwritingRecognitionModel(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    model = Model.createModel(context, "handwriting_recognition_model.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static HandwritingRecognitionModel newInstance(@NonNull Context context) throws
      IOException {
    return new HandwritingRecognitionModel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static HandwritingRecognitionModel newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new HandwritingRecognitionModel(context, options);
  }
